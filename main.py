...
class Joueur():	
	def __init__(self, mode=""):
		...
		#Creation de la Map
		self.nombre_bloc = 30 #visible à l'écran en longueur
	...
	def afficher_robots(self):
		# for robot in self.liste_robots:
			# robot.afficher(True, self.camera.get_position())
		self.robot_joueur.afficher(True, self.camera.get_position())
		self.robot_adversaire.afficher(self.adversaire_visible, self.camera.get_position())
