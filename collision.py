...
def Cercle_Cercle(x1, y1, r1, x2, y2, r2):
	if AABB_AABB( (x1-r1, y1-r1, 2*r1, 2*r1), (x2-r2, y2-r2, 2*r2, 2*r2)):
		if distance_carre(x1, y1, x2, y2) <= (r1+r2)**2:
			return True
	return False
	
def AABB_AABB(aabb1, aabb2):
	x1, y1, w1, h1 = aabb1
	x2, y2, w2, h2 = aabb2
...
def Cercle_AABB(centre_cercle, rayon, aabb):
	x, y = centre_cercle
	x1, y1, w1, h1 = aabb
