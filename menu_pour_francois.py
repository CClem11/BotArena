...
sniper2 = pygame.transform.scale(pygame.image.load("ressources/sniper2.jpg").convert(), (largeur_image, hauteur_image))
commando1 = pygame.transform.scale(pygame.image.load("ressources/commando.jpg").convert(), (largeur_image, hauteur_image))

cochee = pygame.transform.scale(pygame.image.load("ressources/cocher.png").convert(), (100, 100))
non_cochee = pygame.transform.scale(pygame.image.load("ressources/non_cochee.png").convert(), (100, 100))

classes = [commando1, sniper, sniper2]
nom_classe = ["Commando", "Sniper", "Titi"]
...
while True:
	...
	for numero_image, img in enumerate(classes):
		...
		if numero_image == selection or numero_image == selection_clic:
			...
			pygame.draw.rect(affichage, couleur, (x1,150,2*largeur_image-5*2, dimension_fenetre[1]-250),5)
