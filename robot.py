...
from projectile import Projectile, Fumee
# from webcam import *
...
class Robot():
	def __init__(self, game_display, map, position_initiale, name="Player 1"):
		...
		############
		self.img_canon3 = pygame.image.load("ressources/canon tourelle.png").convert_alpha()
		self.img_chassis_touche = pygame.image.load("ressources/chassis3_touche.png").convert_alpha()
		self.img_chassis_mort = pygame.image.load("ressources/chassis3_mort.png").convert_alpha()
		self.fumee = pygame.image.load("ressources/fumee_tir.png").convert_alpha()
	...
	def afficher(self, visible=True):
